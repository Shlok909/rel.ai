...
import MessageAnalyzerClient from "./MessageAnalyzerClient";

export default async function MessageAnalyzerPage() {
  const featureId = "msg";
  const moduleId = "reply";
  ...
  return (
    <AppShell>
      <TopBar title={feature?.uiName || "Analyzer"} credits={credits} showBack />
