...
export async function POST(req: Request) {
  try {
    ...
    const uiName = template.META?.uiName || "Signs & Observations";
    const summaryText = `Vibe: ${result.vibe_label || "Reading"}`;
    ...
    console.error("API error in signs-observations:", error);
    return NextResponse.json(
